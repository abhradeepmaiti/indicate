...
class TestPunjabiToEnglish(unittest.TestCase):
    def test_punjabi_to_english(self):
        # Characterizes the shipped Punjabi model's deterministic (beam-search)
        # output on common Gurmukhi names.
        test_inputs = ["ਰਵਿ ਸ਼ਰਮਾ", "ਨੰਦ ਲਾਲ", "ਸਿੰਘ", "ਕੌਰ", "ਗੁਰਪ੍ਰੀਤ"]
        test_outputs = ["ravi sharma", "nand laal", "singh", "kaur", "gurpreet"]
